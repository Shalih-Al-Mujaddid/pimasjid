            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="card bg-slate-50 dark:bg-slate-800/50 border-none hover:bg-white dark:hover:bg-slate-800 shadow-none hover:shadow-2xl transition-all duration-500 p-8 rounded-[2.5rem] group">
                        ...
                        <h3 class="text-xl font-black text-persian-navy dark:text-white mb-4 uppercase tracking-tighter leading-none">Ambulans Gratis</h3>
                        ...
                        <a href="#" class="text-persian-blue font-black text-[10px] uppercase tracking-widest flex items-center gap-1 group-hover:gap-2 transition-all">Hubungi <ArrowRightIcon class="w-3 h-3" /></a>
                    </div>
                    ...
                    <div class="card bg-slate-50 dark:bg-slate-800/50 border-none hover:bg-white dark:hover:bg-slate-800 shadow-none hover:shadow-2xl transition-all duration-500 p-8 rounded-[2.5rem] group">
                        ...
                        <a href="#" class="text-persian-gold font-black text-[10px] uppercase tracking-widest flex items-center gap-1 group-hover:gap-2 transition-all">Bantu <ArrowRightIcon class="w-3 h-3" /></a>
                    </div>
                    ...
                    <div class="card bg-slate-50 dark:bg-slate-800/50 border-none hover:bg-white dark:hover:bg-slate-800 shadow-none hover:shadow-2xl transition-all duration-500 p-8 rounded-[2.5rem] group">
                        ...
                        <a href="#" class="text-persian-azure font-black text-[10px] uppercase tracking-widest flex items-center gap-1 group-hover:gap-2 transition-all">Jadwal <ArrowRightIcon class="w-3 h-3" /></a>
                    </div>
                </div>
            </div>
        </section>
