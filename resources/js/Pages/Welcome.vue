        ...
        <section class="py-24 bg-white dark:bg-slate-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-20">
                    <span class="badge badge-soft bg-bakri-teal/10 text-bakri-teal border-none uppercase tracking-widest font-bold mb-3">Program Unggulan</span>
                    <h2 class="text-3xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tight leading-none">Layanan & Fasilitas</h2>
                    <div class="w-16 h-1 bg-bakri-teal mx-auto mt-6 rounded-full"></div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="card bg-slate-50 dark:bg-slate-800/50 border-none hover:bg-white dark:hover:bg-slate-800 shadow-none hover:shadow-2xl transition-all duration-500 p-8 rounded-[2.5rem] group">
                        ...
                        <h3 class="text-xl font-black text-slate-800 dark:text-white mb-4 uppercase tracking-tighter leading-none">Lumbung Pangan</h3>
                        ...
                        <a href="#" class="text-bakri-teal font-black text-[10px] uppercase tracking-widest flex items-center gap-1 group-hover:gap-2 transition-all">Bantu <ArrowRightIcon class="w-3 h-3" /></a>
                    </div>
