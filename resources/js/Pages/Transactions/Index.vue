    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex flex-col md:flex-row justify-between md:items-center gap-4">
                <h2 class="font-semibold text-2xl text-slate-800 leading-tight flex items-center gap-2">
        ...
        <Modal :show="showCreateModal" @close="showCreateModal = false">
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                     <h3 class="text-lg font-bold text-slate-900">Input Transaksi Baru</h3>
                 ...
                 <form @submit.prevent="submitCreate" class="space-y-4">
                        ...
                        <div>
                            ...
                            <select v-model="form.category" class="w-full rounded-lg border-slate-300 focus:border-emerald-500 focus:ring-emerald-500 text-sm">
                        ...
                        <!-- Amount & Date -->
                         <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="form.amount" type="number" min="0" class="w-full rounded-lg border-slate-300 focus:border-emerald-500 focus:ring-emerald-500 text-sm" placeholder="Contoh: 500000" />
                        ...
                        <div>
                            ...
                            <textarea v-model="form.description" rows="2" class="w-full rounded-lg border-slate-300 focus:border-emerald-500 focus:ring-emerald-500 text-sm" placeholder="Detail transaksi..."></textarea>
                            <p v-if="form.errors.description" class="mt-1 text-xs text-red-600">{{ form.errors.description }}</p>
                        </div>

                        <!-- Proof Image -->
                        <div v-if="form.type === 'expense'" class="border border-dashed border-amber-300 rounded-lg p-4 bg-amber-50">
                            <label class="block text-sm font-medium text-slate-700 mb-2">📸 Bukti (Wajib untuk pengeluaran)</label>
