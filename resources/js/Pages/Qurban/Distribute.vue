        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm p-8">
                    <h3 class="text-lg font-semibold text-slate-800 mb-6">Form Distribusi Daging</h3>
                    
                    <form @submit.prevent="submit" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium text-slate-700 mb-2">Pilih Qurban *</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-2">Kategori Penerima *</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-2">Berat Daging (kg) *</label>
                ...
                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                    <div class="px-6 py-4 bg-slate-50 border-b">
                        <h3 class="font-semibold text-slate-800">Riwayat Distribusi</h3>
                    </div>

                    <table class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-slate-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase">Qurban</th>
                        ...
                        <tbody class="bg-white divide-y divide-slate-200">
                            <tr v-for="dist in distributions.data" :key="dist.id" class="hover:bg-slate-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="font-medium text-slate-900">{{ dist.recipient_name }}</div>
                                </td>
                                <td class="px-6 py-4">
